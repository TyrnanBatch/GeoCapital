...
const Endgame = ({ longitude1, latitude1, longitude2,latitude2,country1,country2, capital1, capital2,
  ...
  useEffect(() => {
    if (!hasShownRef.current) {
      const firstTimeout = setTimeout(() => setShowFirst(true), 200);
...
<Text style={{color: 'black',fontSize: screenWidth * 0.035,
...
<View style={{ height: screenWidth * 0.05, justifyContent: 'space-evenly', }}>
<View style={{width: '100%', alignItems: 'center'}}>
<Text style={{color: 'black',fontSize: screenWidth * 0.024,
...
<Text style={{color: 'black',fontSize: screenWidth * 0.025,
