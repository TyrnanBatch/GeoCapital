...
const EndgameFour = ({ 
  longitude1, latitude1, longitude2,latitude2,country1,country2,
  longitude3, latitude3, longitude4,latitude4,country3,country4,
  capital1,capital2,capital3,capital4,
  score,
  game,
  onButtonPressReset,
  PinTop1,PinLeft1,PinTop2,PinLeft2,
  PinTop3,PinLeft3,PinTop4,PinLeft4,
 }) => {
...
{score > 3 && onHighScore && (
    ...
    <View style={{ 
       ...
       <MapPin 
        ...
        top3={PinTop3} left3={PinLeft3} 
        top4={PinTop4} left4={PinLeft4} 
      />
      </View>
