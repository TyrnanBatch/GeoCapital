...
// import { View, Dimensions, Animated, PanResponder, Text, TouchableOpacity, Image, Easing,StyleSheet, } from 'react-native';
...
//     // Remove non-numeric characters except periods and convert to integer
...
// )}
// {topBar && (
//           <GameTopBar direction={direction} count={counter} game={game} />
//         )}
...
//               <View style={{ height: screenWidth * 0.3, zIndex: 100,width: screenWidth, alignItems: 'center', justifyContent: 'center' }}>
//                 <Image
//                   key={key}
//                   source={gifUrl}
