...
// const Carousel = ({ scrollX, fadeAnim, cardFadeAnim, cardTranslateAnim }) => {
//   const data = [
//     <CardTest name="LocationGame" backgroundColor="#F5E7A0" backgroundColor2="#8B6E42" />,
//     <CardTest name="FlagGame" backgroundColor="#E7A0A0" backgroundColor2="#7A4848"/>,
//     <CardTest name="PopulationGame" backgroundColor="#A0E7A5" backgroundColor2="#427A42"/>,
//     <CardTest name="CapitalsGame" backgroundColor="#C6A0E7" backgroundColor2="#6A4282"/>,
//     <CardTest name="SizeGame" backgroundColor="#A0D8E7" backgroundColor2="#426F7A"/>, 
//   ];
...
//           inputRange,
//           // outputRange: isPad ? [width * 0.05, -width * 0.05, width * 0.05] : [width * 0.05, -width * 0.05, width * 0.05],
//           outputRange: isPad ? [-screenWidth * 0.08, -screenWidth * 0.08, -screenWidth * 0.08] : [screenWidth * 0.02, -screenWidth * 0.18, screenWidth * 0.02],
//         });
...
// import React, { useRef } from 'react';
// import { View, StyleSheet, Dimensions, Animated, Platform, TouchableOpacity, Text } from 'react-native';
// import CarouselCardOne from './CarouselCardOne';
// import CarouselCardTwo from './CarouselCardTwo';
// import CardTest from './CardTest';
...
// const Carousel = ({ scrollX, fadeAnim, cardFadeAnim, cardTranslateAnim, toggleGif }) => {
//   const data = [
//     <CardTest name="LocationGame" backgroundColor="#F5E7A0" backgroundColor2="#8B6E42" />,
//     <CardTest name="FlagGame" backgroundColor="#E7A0A0" backgroundColor2="#7A4848"/>,
//     <CardTest name="PopulationGame" backgroundColor="#A0E7A5" backgroundColor2="#427A42"/>,
